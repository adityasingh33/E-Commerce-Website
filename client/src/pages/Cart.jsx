...
// ✅ FIXED: Made import consistent with Checkout component
import cartService from '../feature/CartService.jsx'; // Added .jsx extension
...
const Cart = () => {
  const navigate = useNavigate(); // ✅ FIXED: Changed from 'nav' to 'navigate' for consistency
  ...
  // ✅ FIXED: Better checkout navigation handler
  const handleCheckout = () => {
    ...
    try {
      ...
      alert('Could not navigate to checkout. Please try again.');
    }
  };
      ...
      <main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 sticky top-24">
            ...
            {/* ✅ FIXED: Updated button to use the new handler */}
            <button
